...
const SideNav: React.FC<SideNavProps> = ({
  ...
  const handleUserAction = (
    action: "settings" | "profile" | "logout",
    event: React.MouseEvent
  ) => {
    event.stopPropagation();
    if (action === "profile") {
  ...
  return (
    <SidebarContent className="bg-gray-900 overflow-x-hidden">
      {/* Header */}
                      ...
                      <SidebarMenuItem key={chat._id} className="relative">
                        ...
                        >
                          <div className="flex items-center relative">
                            <div
                              className="flex-1 cursor-pointer py-2 px-2 overflow-hidden"
                            ...
                            >
                              <div className="flex items-center gap-2 w-full min-w-0">
                                <span
                                  ...
                                  style={{
                                    maxWidth: "180px", // or whatever fits nicely in your sidebar
                                  }}
                                >
                                  {chat.title}
                                </span>
                            ...
                            <div className="flex-shrink-0 px-2">
                              <button
                                ...
                                style={{
                                  opacity:
                                    openDropdown === chat._id ? "1" : "0",
                                  transition: "opacity 0.2s ease",
                                }}
                                onClick={(e) =>
                                  handleDropdownToggle(chat._id, e)
                                }
                                onMouseEnter={(e) => {
                          ...
                          {openDropdown === chat._id && (
                            ...
                            >
                              <div className="py-1">
                                <button
                                  onClick={(e) =>
                                    handleChatAction("archive", chat._id, e)
                                  }
                                ...
                                <button
                                  onClick={(e) =>
                                    handleChatAction("delete", chat._id, e)
                                  }
